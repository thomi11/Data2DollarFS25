...
graph_config = {
    "llm": {
        "model": "ollama/llama3.2",  # Specify the model for the llm
...
smart_scraper_graph = SmartScraperGraph(
    ...
    prompt="List all stores with addresses",
    # Source URL or HTML content to scrape
    #source="https://www.dataedgehub.com",
    source= "https://bionetz.ch/adressen/detailhandel/bio-fachgeschaefte/all.html",
